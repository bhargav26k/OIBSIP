      ...
      while(true){
         ...
         int p=sc.nextInt();
          ...
          if(s.equals(mail) && p == pp){
            ...
            System.out.println("The Mail or Password you entered are incorrect"); 
...
System.out.println("Name : bhargav");

System.out.println("Mail : bhargav2691@gmail.com");
